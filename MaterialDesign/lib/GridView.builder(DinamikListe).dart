...
class _MyHomePageState extends State<MyHomePage> {
  ...
  var ulkeler=["Türkiye","Almanya","İtalya","Rusya","Çin","İsviçre","Hollanda","Amerika","Endonezya","Küba","Karadağ","Sırbistan"];
  @override
  Widget build(BuildContext context) {
          ...
          itemBuilder: (context,indeks){
            return GestureDetector(
              ...
              child: Card(
                ...
                child: Row(
                  children: [
                    Text(ulkeler[indeks],style: TextStyle(fontWeight: FontWeight.bold),),
                    Spacer(),
                    PopupMenuButton(
